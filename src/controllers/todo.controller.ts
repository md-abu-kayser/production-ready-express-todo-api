...
export const getPaginatedTodos = asyncHandler(async (req: Request, res: Response) => {
  ...
  if (paginationParams.limit && (paginationParams.limit < 1 || paginationParams.limit > 100)) {
    res.status(400).json({
      success: false,
